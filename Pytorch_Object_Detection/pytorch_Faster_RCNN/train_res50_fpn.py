...
"""
Author: LGD
FileName: train_res50_fpn
DateTime: 2021/3/3 10:17 
SoftWare: PyCharm
"""
import os
...
from pytorch_Faster_RCNN import transforms
from pytorch_Faster_RCNN.network_files.faster_rcnn_framework import FasterRCNN, FastRCNNPredictor
from pytorch_Faster_RCNN.backbone.resnet50_fpn_model import resnet50_fpn_backbone
from pytorch_Faster_RCNN.my_dataset import VOC2012DataSet
from pytorch_Faster_RCNN.train_utils import train_eval_utils as utils
...
def main(parser_data):
    ...
    if len(train_loss) != 0 and len(learning_rate) != 0:
        from pytorch_Faster_RCNN.plot_curve import plot_loss_and_lr
        plot_loss_and_lr(train_loss, learning_rate)

    # plot mAP curve
    if len(val_mAP) != 0:
        from pytorch_Faster_RCNN.plot_curve import plot_map
        plot_map(val_mAP)
