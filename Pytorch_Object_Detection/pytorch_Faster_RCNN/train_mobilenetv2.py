...
"""
Author: LGD
FileName: train_mobilenetv2
DateTime: 2021/3/3 10:07 
SoftWare: PyCharm
"""
import os
...
from pytorch_Faster_RCNN.network_files.faster_rcnn_framework import FasterRCNN
from pytorch_Faster_RCNN.network_files.rpn_function import AnchorsGenerator
from pytorch_Faster_RCNN.backbone.mobilenetv2_model import MobileNetV2
